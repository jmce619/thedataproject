...
(function () {
          ...
          merge: function () {
            this
              ...
              .on("mouseover", function(d) {
                ...
                pct = ((d.made/d.attempts)*100).toFixed(1)
                tooltip.innerHTML = `<span class="tooltip-pct">${pct}%</span><br>${d.made} of ${d.attempts}`;

                tooltip.style.left = (d3.event.pageX + 10) + 'px';
                tooltip.style.top = (d3.event.pageY + 10) + 'px';
                tooltip.style.opacity = 1;
                tooltip.style.display = 'block';
                tooltip.style.transform = 'translateY(0px)'; // Moves the tooltip into its final position smoothly
                ...
                .on("mouseout", function() {
                  ...
                  tooltip.style.transform = 'translateY(-10px)'; // Moves the tooltip slightly upwards as it fades out
  ...
  d3.chart.initializeDefaults(BasketballShotChart, {
    ...
    heatScale: d3.scale.quantize()
      .domain([0, 1])
      .range(['#8B0000', '#E34234', '#ADD8E6', '#87CEEB', '#00008B']),    // height of svg
    height: undefined,
